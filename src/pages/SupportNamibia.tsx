...
const orgs = [
  {
    ...
    impact: ["1,200+ students supported annually", "15 schools in rural areas", "School supplies and infrastructure"],
  },
  {
    ...
    impact: ["150+ desert elephants protected", "Human-wildlife conflict reduced 60%", "20+ local jobs created"],
  },
  {
    ...
    impact: ["80+ children in residential care", "200+ families supported", "Education and healthcare provided"],
  },
];
    ...
    <div className="min-h-screen">
      ...
      <section className="bg-card py-20">
        <motion.div {...fadeUp} className="max-w-4xl mx-auto px-6">
          ...
          <div className="prose prose-lg max-w-none text-muted-foreground leading-relaxed space-y-6">
            <p>
              For Namibia's conservation efforts to succeed long-term, they must be led by Namibians themselves.
              Education provides local communities with the environmental knowledge and technical skills to develop
              solutions tailored to their unique challenges—from managing water scarcity in the Namib Desert to
              protecting biodiversity in Etosha National Park.
            </p>
            <p>
              In tourism, this approach creates tangible benefits. When educated Namibians develop and operate their own
              tourism enterprises, economic gains stay within the community. Visitors experience authentic cultural
              connections, while local heritage is preserved and livelihoods are strengthened.
            </p>
            <p>
              Beyond conservation, education expands opportunity across every aspect of life—opening pathways to
              meaningful employment, improving health outcomes, and empowering Namibians to shape their own future.
            </p>
            <p className="font-semibold text-navy-dark">
              At Pocket Guide Namibia, we're committed to supporting this vision. We promote environmental conservation
              while championing educational opportunities for the people who call this extraordinary landscape home.
            </p>
          </div>
        </motion.div>
      </section>
      ...
      <section className="bg-accent py-20">
        <div className="max-w-5xl mx-auto px-6">
          <motion.h2 {...fadeUp} className="text-4xl font-heading font-bold text-navy-dark mb-12 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            >
              ...
              <h3 className="text-2xl font-heading font-bold text-navy-dark mb-3">Standard Bookings</h3>
              <p className="text-muted-foreground">
                When you book vehicles, accommodations, or activities through Pocket Guide Namibia, 5% of our commission
                goes directly to support our partner organizations.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-2xl font-heading font-bold text-navy-dark mb-3">Premium Members</h3>
              <p className="text-muted-foreground">
                Pocket Guide Premium subscribers contribute even more—10% of membership fees directly support education
                and conservation initiatives across Namibia.
              </p>
            </motion.div>
          </div>

          <p className="text-center text-lg text-muted-foreground">
            100% of designated funds go directly to our partner organizations—no administrative fees deducted.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <motion.div {...fadeUp} className="text-center mb-16">
            <h2 className="text-4xl font-heading font-bold text-navy-dark mb-4">
              Take a closer look into some of the projects we are currently working with
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              We partner with organizations making real, measurable impact in conservation, education, and community
              development.
            </p>
          </motion.div>
      ...
      <section className="bg-card py-20">
        <motion.div {...fadeUp} className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-4xl font-heading font-bold text-navy-dark mb-6">Ready to Make a Difference?</h2>
          <p className="text-xl text-muted-foreground mb-10">
            Start planning your Namibian adventure and contribute to these life-changing initiatives.
          </p>
